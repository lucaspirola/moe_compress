...
- **Consumer side already down-ready (NO change):** `stage4/plugins/eora_compensation.py:537-544` keys `(layer,e,"down_proj")` for the down matrix (no gate fallback — by design); `stage3/plugins/aa_svd_factor.py:408-415` (`_cov_lookup`) returns the down key if present; `d_rank_allocate.py:362-394`, `swift_svd_alpha.py:757-778` consume it. Once captured + merged, they weight down automatically.
...
- Consumers (NO change, for validation): `stage4/plugins/eora_compensation.py:537-544`, `stage3/plugins/aa_svd_factor.py:408-415`, `stage3/plugins/d_rank_allocate.py:362-394`, `stage3/plugins/swift_svd_alpha.py:757-778`.
