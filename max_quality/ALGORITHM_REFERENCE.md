...
Using across-batch maxima is valid because MAs are input-stable (paper §3.2.1 "Super Experts Profiling", lines 405–406: "their distribution remains stable across different input datasets").
