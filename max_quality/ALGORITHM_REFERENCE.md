...
E = −Σ_l (c_l / C_total) × log(c_l / C_total)   (cross-layer entropy; c_l = |C_l| is the cluster count for layer l, C_total = Σ_l |C_l| — matches paper Eq. 9 notation p_l = |C_l|/Σ_{l'} |C_{l'}|)
```
